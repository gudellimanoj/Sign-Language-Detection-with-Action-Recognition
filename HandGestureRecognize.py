...
main = tkinter.Tk()
main.title("Gesture Path Real-Time Sign Language Detection with Action Recognition")
...
font = ('times', 16, 'bold')
title = Label(main, text='Gesture Path Real-Time Sign Language Detection with Action Recognition',anchor=W, justify=CENTER)
