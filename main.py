...
# Facial Expression Detection related code
...
# Setup for Gesture Recognition
main = tkinter.Tk()
main.title("Gesture Path Real-Time Sign Language Detection with Action Recognition & Facial Expression Detection")
    ...
    while(True):
        ...
        if ret == True:
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.putText(frame, em + " " + str(score*100) + '%', (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
# GUI for Gesture and Facial Expression detection
font = ('times', 16, 'bold')
title = Label(main, text='Gesture Path Real-Time Sign Language Detection with Action Recognition & Facial Expression Detection', anchor=W, justify=CENTER)
...
facialExpButton = Button(main, text="Facial Expression Recognition from Webcam", command=facialExpression)
facialExpButton.place(x=50, y=300)
facialExpButton.config(font=font1)
